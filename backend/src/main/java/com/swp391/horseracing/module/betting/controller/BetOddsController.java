package com.swp391.horseracing.module.betting.controller;
...
public class BetOddsController {
    ...
    public ApiResponse<String> updateBatchOdds(@PathVariable Integer raceId,
                                               @Valid @RequestBody List<EntryBetOddsRequest> requests) {
    ...
    public ApiResponse<String> toggleBettingStatus(@PathVariable Integer raceId,
        ...
        try {
            ...
            return ApiResponse.error(ErrorCode.UNCATEGORIZED_EXCEPTION, "Invalid status. Allowed: open, closed, suspended, pending");
        }
